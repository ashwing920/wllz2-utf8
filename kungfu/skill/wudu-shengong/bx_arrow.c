...
int exert(object me, object target)
{
	...
	if(me->query("family/family_name") != "五毒神教")
		return notify_fail("碧血箭乃是五毒神教独门绝技，你是从哪学来的？\n");
	...
	if((int)me->query_skill("force",1) < 100 
	 || (int)me->query_skill("wudu-shengong",1) < 100 )
	...
	if((int)me->query("combat_exp") < (int)target->query("combat_exp")/10)
		return notify_fail("对方武功至少强你十倍，不会有用的，还是快跑吧！\n");
