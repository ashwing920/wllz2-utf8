...
int perform(object me, object target)
{
	...
	if( (int)me->query_skill("taiji-shengong",1) < 120 )
		return notify_fail("你的太极神功等级不够，不能使用「梯云纵」！\n");  
