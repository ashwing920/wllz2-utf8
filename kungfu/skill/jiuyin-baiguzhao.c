...
int valid_research() { return 100;} // 允许在100级以上就可以研究。
...
void skill_improved(object me)
{
	...
	tell_object(me,HIR "不知不觉中，你的杀气正快速的增长。\n"NOR);
	me->add("shen", -(int)me->query_skill("jiuyin-baiguzhao",1));
	me->add("shen_learn",-(int)me->query_skill("jiuyin-baiguzhao",1));
	me->add("bellicosity",(int)me->query_skill("jiuyin-baiguzhao",1));
}
mixed hit_ob(object me, object victim, int damage_bonus)
{
	...
	&& (me->query("neili") > 100)) {
		victim->receive_damage("qi",(damage_bonus - 100) / 3);
		me->add("neili",-100);
