...
mapping *action = ({
  ([
	"action":"$N忽然纵声长啸，横跃于空，取君上弦。只听弓弦响处，\n$w已到$n左肩，眼看就要对穿而过！这招「李广射石」果然有穿石之力",
	"damage":	  25,
	"dodge":	  -20,
	"parry":	  10,
	"damage_type": "刺伤",
  ...
  ([
	"action":"突然间，$N几个筋斗倒翻而去，已在$n数丈之外。$n正待追击，\n$N忽然转身，好一个「百步穿杨」，$w已带着破空之声，直射$n面门",
	"damage":   20,
	"dodge":	   -10,
	"parry":	   -10,
	"damage_type":   "刺伤",
  ...
  ([
	"action":"$N力开长弓，瞄准$n的左臂虚晃一箭。$n纵起闪避，突然发现并无羽箭射来。\n正在无处可去时，$N弯弓搭箭，只见一支$w向$n的$l疾飞而至",
	"damage":   25,
	"dodge":	   -20,
	"parry":   10,
	"damage_type":   "刺伤",
