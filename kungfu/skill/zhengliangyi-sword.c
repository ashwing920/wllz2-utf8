...
mapping *action = ({
([  
	"action":"$N使一式「"+YEL+"百丈飞瀑"+NOR+"」，手中$w剑峰从半空直泻下来刺向$n的$l",
	"force" : 120,
	"lvl" : 0,
...
([  
	"action":"$N错步上前，使出「"+MAG+"雨打飞花"+NOR+"」，走的全是斜势，使你极难捉摸，$w淡淡地向$n的$l挥去",
	"force" : 140,
	"lvl" : 8,
...
([  
	"action":"$N一式「"+WHT+"木叶萧萧"+NOR+"」，手腕一抖，剑光暴涨，手中$w遥摇指向$n的$l",
	"force" : 160,
	"lvl" : 15,
...
([  
	"action":"$N，一式「"+WHT+"无声无色"+NOR+"」，银光万道，如江河倒泻，剑芒绵绵无尽向$n的$l击出",
	"force" : 280,
	"lvl" : 50,
...
([  "action":"$N呼的一声拔地而起，一式「"+HIG+"普天甘露"+NOR+"」，剑出如风，剑影如山罩向$n",
	"force" : 420,
	"lvl" : 110,
...
{
	return __DIR__"zhengliangyi-sword/" + action;
}
