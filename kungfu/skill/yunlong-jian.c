...
mapping *action = ({
([	"action":"$N使一式「悠悠顺自然」，手中$w嗡嗡微振，幻成一条白光刺向$n的$l",
	"force" : 120,
	"dodge" : -10,
	"damage": 15,
	"lvl" : 0,
...
([	"action":"$N一式「志当存高远」，纵身飘开数尺，运发剑气，手中$w遥摇指向$n的$l",
	"force" : 160,
	"dodge" : 5,
	"damage": 30,
	"lvl" : 15,
...
([	"action":"$N手中$w斜指苍天，剑芒吞吐，一式「云龙听梵音」，对准$n的$l斜斜击出",
	"force" : 280,
	"dodge" : 25,
	"damage": 45,
	"lvl" : 50,
...
([	"action":"$N呼的一声拔地而起，一式「日月与同辉」，$w幻出万道光影，将$n团团围住",
	"force" : 420,
	"dodge" : 15,
	"damage": 70,
	"lvl" : 80,
