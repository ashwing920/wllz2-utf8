...
([	"action" : "$N向前跃上一步，左手剑诀，右手$w使出一式「"WHT"破雾势"NOR"」直刺$n的$l",
	"force" : 140,
	"dodge" : -10,
	"damage" : 30,
	"lvl" : 10,
...
([	"action" : "$N一式「"HIC"搅海势"NOR"」，$w自左而右划出一个大弧，平平地向$n的$l挥去",
	"force" : 190,
	"dodge" : 5,
	"damage" : 40,
	"lvl" : 30,
...
([	"action" : "$N运气施出「"HIB"雷针势"NOR"」，$w剑尖逼出一道青芒，闪电般破空射向$n的$l",
	"force" : 350,
	"dodge" : 5,
	"damage" : 75,
	"lvl" : 57,
...
([	"action" : "$N双腿半屈半蹲，一式「"BLINK + HIY"龙吞势"NOR"」，剑尖划出无数圆圈，狂风骤起，笼罩天地",
	"force" : 400,
	"dodge" : 5,
	"damage" : 90,
	"lvl" : 64,
