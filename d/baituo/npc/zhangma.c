...
string inquiry_hua()
{
	...
	object obn;
	message_vision("张妈说道：这位"+ RANK_D->query_respect(me)+"，『金花』是我的亲闺女，甭提多孝顺了！\n可惜去年上山割草就一去不会，也不知是死是活。唉￣\n", me);
 	if(query_temp("shoe")==0){ 
		return "这位"+ RANK_D->query_respect(me)+"，我已经托人去寻找了，也不知道怎么样了。\n";
 }
	message_vision("张妈又说道：这位"+ RANK_D->query_respect(me)+"，我这里有她落在草丛里的一只「绣花鞋」，\n你要是找到『金花』，就把鞋交给她，她会明白的。\n我女儿『金花』的命运，就托给你了。\n" , me);
	obn=new("/d/baituo/obj/shoe");
	obn->move(me);
	set_temp("shoe",0);
	message_vision("张妈从怀里摸出一只「绣花鞋」，交给$N。\n",me);
	return "谢谢你了，"+ RANK_D->query_respect(me)+"。\n";
}
