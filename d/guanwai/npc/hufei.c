...
void create()
{
        ...
        set("age", 25);
        set("long", @LONG
他就是胡一刀之子，因其武功高强神出鬼没。在江湖上人送外号「雪山飞
狐」。他身穿一件白色长衫，腰间别着一把看起来很旧的刀。他满腮虬髯
，根根如铁，一头浓发，却不结辫。
LONG
);
...
int accept_object(object me, object ob)
{
        ...
        command("say 这位" + RANK_D->query_respect(me)+"，如此大恩大德，在下实不知何以为报。");
        command("say 阎基，你这狗贼！想不到你也有今天！！");
        write(HIR"\n胡斐手起刀落，将阎基剁为两段，阎基一声惨嚎，躺倒在了血泊之中！\n"NOR);
        command("chat 哈哈！我终于为家父报仇血恨啦！！");
...
string ask_book()
{
        ...
        if((int)(me->query("shen")<10000))
                ...
                write("胡斐说着转身从阎基尸身上搜出一本破旧书本，递了给你。\n");
                call_out("waiting",0,me,ob);
                add("book_count", -1);
