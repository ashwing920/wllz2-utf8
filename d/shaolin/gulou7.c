...
架子底层搁着两根大鼓槌。尽管山风吹人欲倒，谁都禁不住想要击一下鼓
(drum)试试。往外看，有个很大的汉白玉窗台(out)，上面足可站一个人。
旁边有张纸(paper)，好象写着些什么。
LONG
);
        set("exits", ([
...
int do_hit(string arg)
{
        ...
        else
        {
                ...
                write("鼓声如迅雷般在你耳边炸响，你头脑中一片糊涂，全身摇摇欲坠，勉\n
                      力支撑着不倒在地上。心中一个声音告诉你，得赶快离开这里，不然就没命了。\n");
         if (random(2)==0) {
...
int do_out(string arg)
{
        ...
        if( i < 50) {
        message("channel:rumor",HIM"【武林传奇】某人："+ me->name()+"从鼓楼七层跌下来摔死了。\n"NOR,users());
        me->die();
        }
        else if( i < 125) me->unconcious();
        else {
