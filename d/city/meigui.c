...
int do_broadcast(string arg)
{
        ...
        message("channel:chat", HIC+"【玫瑰宴厅】"+mesg+NOR, users() );
        message("channel:chat", HIR+"【玫瑰宴厅】"+mesg+NOR, users() );
        message("channel:chat", HIG+"【玫瑰宴厅】"+mesg+NOR, users() );
        return 1;
}
...
int do_order(string arg)
{
        ...
        if (arg == "marry") {
                mesg = me->name() + "现在在醉仙楼玫瑰厅举行订婚酒宴了！！！\n";
                if (me->can_afford(30000) == 0) return 0;
                me->pay_money(me,30000);
