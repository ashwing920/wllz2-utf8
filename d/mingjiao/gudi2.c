...
void create()
{
	set("short", "昆仑谷底");
	set("long", @LONG
翻过那堵屏风也似的大山壁。眼前依旧茫茫云海，更无去路，山石坚
硬无比，你看到右边有一株大松树(tree)，左侧山壁黑黝黝似乎有个小山
洞(dong)。
LONG
);
...
int do_enter(string arg)
{
	...
	else
	{
		...
		message_vision("能，坚硬的石壁压在他胸口背心，竟然气也喘不过来。$N窒息难受，只得后退，不料身\n", me);
		message_vision("子嵌在坚石之中，前进固是不能，后退却也已不得，这一下$N吓得魂飞魄散，竭尽生平\n", me);
		message_vision("之力，双臂向石上猛推，身子才退了尺许，猛觉得胸口一阵剧痛，竟已轧断了一根肋骨。\n"NOR, me);
