...
void create()
{
	set("short", "昆仑仙境");
	set("long", @LONG
向西走了二里多，只见峭壁上有一道大瀑布冲击而下，料想是雪融而
成，阳光照射下尤如一条大玉龙，极是壮丽。瀑布泄在一座清澈碧绿的深
潭(tan )之中，潭水却也不见满，当是另有泄水的去路。你观赏了半晌，
一低头，见手足上染满了清苔污泥，另有无数给荆棘硬草割破的血痕，於
是走近潭边，除下鞋袜，伸足到潭水中去洗涤(xidi)。
LONG
);
