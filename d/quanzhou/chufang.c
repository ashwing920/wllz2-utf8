...
void create()
{
	set("short", "厨房");
	set("long", @LONG
厨房四周摆有几张桌子和椅子，几个老妈子和丫环正忙着烧饭煮菜。
饭菜的香气随风飘送，老远便能闻到，另人垂涎欲滴。你要想吃东西尽管
向老妈子要(serve)，想喝水便自个儿到外面的井去打(fill)。
LONG
);
	set("exits", ([
...
int valid_leave(object me, string dir)
{
	...
	|| present("dian xin",me)
	|| present("tang bao",me))
		return notify_fail("丫环拦着你说：别着急，还是把东西吃完再走吧。\n");
