...
void create()
{
        set("short", "客店后院");
        set("long", @LONG
这里客店后院。一阵阵打斗之声从东面的厢房 (room) 中传来，其中
夹杂着一个女子的声音。房门的板壁(wall)不住的震动，似乎客房四周的
板壁都要被刀风掌力震坍一般。西首也是厢房，不时有人探头出来观望。
北面是客店大门。
LONG
);
        set("no_sleep_room",1);
        ...
        set("item_desc", ([
                "wall" : "这是一堵木墙，板壁不过一寸来厚，被震得摇摇晃晃。\n",
                "room" : "你往房中望去，只见六个喇嘛手持戒刀，围着一白衣女尼拼命砍杀，\n"+
