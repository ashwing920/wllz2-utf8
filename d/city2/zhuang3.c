...
void create()
{
	set("short", "庄府大门");
	set("long", @LONG
这里就是文士庄允城的旧居。自从他被朝廷抓走后，这里好象就没有
人住了。一扇大门(men)紧锁着，周围是高高的围墙(wall) 。一切都很干
净，并没有积多少灰尘。
LONG
);
	set("exits", ([
...
int do_break(string arg)
{
	...
	me = this_player();
	if( !arg || arg != "men") 
		return notify_fail("不要随便打碎别人的东西！\n");
