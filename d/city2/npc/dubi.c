...
void create()
{
        ...
        set("dex", 20);
        set("long",@LONG
这是一位白衣女尼，手握拂尘，目视前方。一只长袖空空如也，显是断了
一臂，尽管如此，仍然掩不住她迷人的风采。
LONG
);
        ...
        set("jiali",160);
        set("inquiry", ([
                "阿珂" :  "神尼叹了一口气，说道：她是我的得意弟子，人长得挺美，唉，只可惜被韦小宝骗去了。\n",
        ]) );
        setup();
...
int do_skills(string arg)
{
        ...
        command("shake");
        command("say 你怎么能看我的武功呢？");
        return 1;
}
        tell_object(ob,"独臂神尼的武功如下：\n"+
"  基本轻功 (dodge)                      - 心领神会 200/    0\n"+
"  基本内功 (force)                      - 心领神会 200/    0\n"+
"  基本招架 (parry)                      - 心领神会 200/    0\n"+
"  基本拳脚 (unarmed)                    - 心领神会 200/    0\n"+
"  基本鞭法 (whip)                       - 心领神会 200/    0\n"+
"□秋风尘法 (qiufeng-chenfa)             - 心领神会 200/    0\n"+
"□神行百变 (shenxing-baibian)           - 心领神会 200/    0\n");
        return 1;
}
...
void greeting(object ob)
{
        ...
        message_vision("白衣女尼对$N说道：“多谢这位"+RANK_D->query_respect(ob)+"拔刀相助，贫尼感激不尽，无以为报。\n这里有一套神行百变身法，你若愿学，贫尼定倾囊以授。”\n",ob);
        if(ob->query("weiwang")<60){
        ob->add("weiwang",10);
