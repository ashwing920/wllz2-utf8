...
int do_tap(string arg)
{
	...
	message_vision("小翠不耐烦地对$N说道：刚给你上过茶你接着就要，你是个Ｒｏｂｏｔ我可不是啊！\n", me);
		return 1;
	}
...
int valid_leave(object me, string dir)
{
	...
	switch ( random(2) ){
	case 0:
	return notify_fail("小翠把嘴一撇：吃饱了喝足了还不够，临走怀里还揣上一些，小女子也替您脸红呢！\n");
	break;
	case 1:
	return notify_fail("小翠对$N道了个万福：张真人吩咐，饮食不得带出茶房。\n");
	break;
	}
