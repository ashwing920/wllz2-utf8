...
void create()
{
	set_name("蜂浆瓶",({"fengjiangping","ping"}));
	set_weight(4500);
	if(clonep())
	...
	set("material","玉");
	set("long",@TEXT
这是一个用上古美玉雕成的小瓶，还未拔开瓶塞，就可以闻到一股浓郁的香味，可以用来驱蜂。
TEXT);
	}
	setup();
}
