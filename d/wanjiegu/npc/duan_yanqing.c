...
void init()
{
	...
	if (interactive(ob = this_player()) && !ob->query_temp("unconcious"))
	{
...
void do_kill(object me, object dest)
{
...
void waiting(object me, object dest)
{
	if ( objectp(dest) )
	{
		if (dest->is_ghost())
...
void checking(object me, object dest)
{
	object ob;
