...
void create()
{
        set("short", "嘉兴南湖");
	set("long",@LONG
这里是嘉兴南湖底，四周黑忽忽的，头顶上看不见一点亮光，身边的
水流忽上忽下的涌动着。看起来是一处海眼。东边似乎有一点亮光，被一
块巨大的石块(stone)挡着。周围一片死寂，似乎暗藏着层层杀机。
LONG
	);
	set("exits", ([
		"up" : __DIR__"tan6",	
...
这是一块巨大的石头，看起来质地是玄武岩的，显得十分的坚硬。你用手
试着推了一把(push)，石头动了一下，马上又回到原地了。从移开一瞬间
，你恍惚看见几缕光线从里面投射出来。看来里面一定别有一番洞天。
TEXT
	]) );
	setup();
}
