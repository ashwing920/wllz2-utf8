...
void create()
{
	...
	set("per", 24);
	set("long",@LONG
乾隆皇帝姓爱新觉罗，名弘历，是大清入关后第四位在位皇帝，生平号称
有十大武功，自称“十全老人”。
LONG
);
	set("combat_exp", 500);
