...
void create()
{
	set("short", "石室");
	set("long", @LONG
进得门来，便觉阵阵有形无质的气浪逼人，功力稍差之人似乎要站立
不稳。几位老者正在场中互较内功，身上衣衫高高蓬起。几名旁观者均背
靠石壁(wall)而立，神色紧张。
LONG );
	set("exits", ([
	...
	set("item_desc", ([
		"wall" : @WALL
墙的正上方刻着「煊赫大梁城」几个大字。下方图案极为简单，绘了一团
烈焰腾空而起，远观却又似混沌太极之形。一行注解写在图案正中：刚不
可久，柔不可守。图外亦注：《光武纪》：气佳哉！郁郁葱葱然。
WALL
	]));
	set("objects", ([
