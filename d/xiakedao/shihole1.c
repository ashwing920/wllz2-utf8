...
void create()
{
	set("short", "石洞");
	set("long", @LONG
这里依次是六个石洞，各自通向四句诗的石室。后人研习「侠客行」
武功，悟出六句总纲，也分别刻在这里。此洞一色青布帷幔，侍立的弟子
均是青衣长剑。正面壁上，粗隶刻着前四句诗的总纲「一剑飞鸿」。
LONG );
	set("exits", ([
		"out"   : __DIR__"neiting",
...
int valid_leave(object me, string dir)
{
	...
	if(dir!="out"){
	   ...
	   {
		   if(objectp(present("wang wu", environment(me))) && living(present("wang", environment(me))))
