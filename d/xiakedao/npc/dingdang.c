...
string inquiry_yu()
{
	...
	if(query_temp("shoupa")==0){
		message_vision("丁当又说道：这位"+ RANK_D->query_respect(me)+"，我已经托人去摩天崖看看了，也不知道怎么样了。\n",me);
		return "真急人！";
	}
		message_vision("丁当又说道：这位"+ RANK_D->query_respect(me)+"，我这里有一个手帕，是我随身之物，\n你看到我的玉哥哥你就把手帕交给他，他会明白的。拜托了。\n" , me);
