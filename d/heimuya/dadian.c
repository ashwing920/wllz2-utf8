...
void create()
{
        set("short", "大殿");
        set("long", @LONG
进得大殿，只见殿堂阔不过三十来尺，纵深却有三百来尺，长端彼端
高设一座椅(chair) ，那座椅套以淡黄锦缎制成，金黄色丝线绣了九条金
龙，捧着中间一个刚从大海之中升起的太阳。那九条金龙张牙舞爪，神采
如生，周围缀了不少明珠、钻石，和诸般翡翠宝石，满堂尽是珠光宝气。
LONG
);
        set("objects", ([
                CLASS_D("riyue")+"/renwoxing" : 1,
                __DIR__"npc/shizhe2" : 4,
        ]));
        set("exits", ([ /* sizeof() == 4 */
...
int do_move(string arg)
{
        ...
        message_vision("$N运足内劲，运力往大座椅一搬。\n", this_player());
        if (n>=200) {
        message_vision("忽然嘭的一声响，大座椅下原来有个地道！\n", this_player());
        ...
        message_vision("$N大吼一声，双手拼命猛搬大座椅，但好象搬不动，看来$N的内力不够强。\n", this_player());
