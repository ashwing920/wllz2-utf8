...
void setup_bird(object ob)
{
	...
	if( undefinedp(my["max_jing"]) ) {
		if( my["age"] <= 3 ) my["max_jing"] = 200;
		else if( my["age"] <= 10 ) my["max_jing"] = 300 + (my["age"] - 3) * 10;
		else if( my["age"] <= 30 ) my["max_jing"] = 400 + (my["age"] - 10) * 3;
		else my["max_jing"] = 400 + (my["age"] - 30);
	}
	if( undefinedp(my["max_qi"]) ) {
		if( my["age"] <= 5 ) my["max_qi"] = 200;
		else if( my["age"] <= 20 ) my["max_qi"] = 300 + (my["age"] - 5) * 15;
		else my["max_qi"] = 400 + (my["age"] - 20) * 5;
	}
	if( undefinedp(my["max_jingli"]) ) {
		if( my["age"] <= 5 ) my["max_jingli"] = 100;
		else if( my["age"] <= 20 ) my["max_jingli"] = 100 + (my["age"] - 5) * 20;
		else my["max_jingli"] = 400 + (my["age"] - 20) * 5;
	}
