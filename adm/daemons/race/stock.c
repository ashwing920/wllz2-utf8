...
void setup_stock(object ob)
{
	...
	if( undefinedp(my["max_jing"]) ) {
		if( my["age"] <= 3 ) my["max_jing"] = 100;
		else if( my["age"] <= 10 ) my["max_jing"] = 200 + (my["age"] - 3) * 20;
		else if( my["age"] <= 30 ) my["max_jing"] = 400 + (my["age"] - 10) * 5;
		else my["max_jing"] = 500 + (my["age"] - 30) * 2;
	}
	if( undefinedp(my["max_qi"]) ) {
		if( my["age"] <= 5 ) my["max_qi"] = 200;
		else if( my["age"] <= 20 ) my["max_qi"] = 300 + (my["age"] - 5) * 20;
		else my["max_qi"] = 500 + (my["age"] - 20) * 5;
	}
