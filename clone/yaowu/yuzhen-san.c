...
int cure_ob(object me)
{
	...
	if((int)me->query_condition("jy_poison")) {
		if((int)me->query_condition("jy_poison") < 30)
			me->clear_condition("jy_poison");
		else
			me->apply_condition("jy_poison",(int)me->query_condition("jy_poison")-30);
	}
	destruct(this_object());
	return 1;
}
